...
/* ------------------------------------------------------------------ */
/*  Rodzinny grajdołek — krąg grupy, widok na starcie (2 rodziny)       */
/* ------------------------------------------------------------------ */
...
/* ---------------- dane ---------------- */
/*  tylko 2 rodziny — tak wygląda krąg zaraz po starcie grupy  */
...
export default function KragGrupyStart() {
        ...
        <header className="kg-head">
          <div className="kg-head-row">
            <div>
              ...
              <div className="kg-head-sub">Środy 16:30 · Sala nr 2 · 2 rodziny</div>
            </div>

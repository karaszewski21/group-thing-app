...
| `party` | `party-archetype-mapper` | "Is there an entity that plays one or more roles, and/or relates to other entities via a named relationship with its own lifecycle?" |
